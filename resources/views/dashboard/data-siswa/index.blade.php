...
<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
            ...
            <a href="{{url('dashboard/data-siswa/tambah-data-siswa') }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-action">
                                    <a class="icon" href="{{ route('siswa.detail', $value->id) }}" title="Detail Data">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a class="icon" href="{{ route('siswa.edit', $value->id) }}" title="Edit Data">
