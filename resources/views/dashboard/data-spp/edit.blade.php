...
<li class="breadcrumb-item"><a href="">Edit Data Tahun <span>{{ $edit->tahun }} </span> </a></li>
@endsection
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <br>
                <form method="POST" action="{{ route('spp.edit', $edit->id) }}">
                    @csrf
                    @method('put')
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-lg-10">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="number" class="form-control @error('nominal') is-invalid @enderror" name="nominal" value="{{ $edit->nominal }}" placeholder="Masukkan Nominal SPP">
