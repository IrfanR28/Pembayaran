...
<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
            <h3 class="card-title"> Table Data SPP</h3>
            <a href="{{url('dashboard/data-spp/tambah-data-spp') }}">
                    ...
                    <tbody class=" border-primary">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-action">
                                    <a class="icon" href="{{ route('spp.edit', $value->id) }}" title="Edit Data">
                        ...
                        <div id="DeleteModal-{{ $value->id}}" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog  modal-sm">
                                <form action=" {{ route("spp.destroy", ['spp' => $value->id]) }}" method="POST">
                                    @csrf
                                    @method('delete')
