...
<li class="breadcrumb-item active"><a href="#">Transaksi Pembayaran</a></li>
@endsection
...
<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
            <h3 class="card-title"> Table Data Transaksi Pembayaran</h3>
                ...
                <table class="table">
                    ...
                    <tbody class=" border-primary">
                        ...
                        <tr>
                            ...
                            <td>{{'Rp. '.$value->siswa->spp->nominal}} </td>
                            <td>{{$value->created_at->format('d M, Y')}}</td>
                            <td>
                                <div class="btn-action">
                                    <a class="icon" href="{{ route('pembayaran.edit', $value->id) }}" title="Edit Data">
                        ...
                        <div id="DeleteModal-{{ $value->id}}" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-sm">
                                <form action=" {{ route("pembayaran.destroy", ['pembayaran' => $value->id]) }}" method="POST">
                                    @csrf
                                    @method('delete')
