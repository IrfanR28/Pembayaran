...
<div class="right-content-3-5">
    ...
    <form style="margin-top: 1.5rem;" action="{{ route('login') }}" method="post">
        ...
        <div style="margin-bottom: 1.75rem;">
            <label for="" class="d-block input-label-content-3-5">{{ __('E-Mail Address') }}</label>
            <div class="d-flex w-100 div-input-content-3-5">
                ...
                <input class="input-field-content-3-5 @error('email') is-invalid @enderror" type="email" name="email" value="{{ old('email') }}" placeholder="Masukkan Email Anda" autocomplete="email" autofocus required>
            </div>
        </div>
        <div style="margin-top: 1rem;">
            ...
            <div class="d-flex w-100 div-input-content-3-5">
                ...
                <input class="input-field-content-3-5 @error('password') is-invalid @enderror" type="password" name="password" placeholder="Masukkan Password" minlength="6" required autocomplete="current-password">
                @error('password')
    ...
    <p class="text-center bottom-caption-content-3-5">Akses untuk Siswa Silahkan disini.
        <span class="green-bottom-caption-content-3-5"><a href="{{ url('login/siswa') }}">Klik Disini</a></span>
    </p>
</div>
@endsection